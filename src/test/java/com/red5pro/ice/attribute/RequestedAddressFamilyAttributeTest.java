 ...
 *
 */
public class RequestedAddressFamilyAttributeTest extends TestCase {
    private RequestedAddressFamilyAttribute requestedAddressFamilyAttribute = null;
    ...
    public void testGetDataLength() {
        ...
        this.requestedAddressFamilyAttribute.setFamily(MsgFixture.REQUESTED_ADDRESS_FAMILY_ATTRIBUTE_V4);
        int actualReturn = this.requestedAddressFamilyAttribute.getDataLength();
        assertEquals("Datalength is not properly calculated", expectedReturn, actualReturn);

        expectedReturn = 1;
        this.requestedAddressFamilyAttribute.setFamily(MsgFixture.REQUESTED_ADDRESS_FAMILY_ATTRIBUTE_V6);
    ...
    public void testEqualsObject() {
        ...
        assertEquals("RequestedAddressFamilyAttribute.equals() failed against a null " + "target.", expectedReturn, actualReturn);
        ...
        assertEquals("RequestedAddressFamilyAttribute.equals() failed against a " + "different target.", expectedReturn, actualReturn);
        ...
        expectedReturn = true;
        actualReturn = requestedAddressFamilyAttribute.equals(target);
        assertEquals("RequestedAddressFamilyAttribute.equals() failed against an equal " + "target.", expectedReturn, actualReturn);

        // ipv6 equality test
        target.setFamily(MsgFixture.REQUESTED_ADDRESS_FAMILY_ATTRIBUTE_V6);

        requestedAddressFamilyAttribute.setFamily(MsgFixture.REQUESTED_ADDRESS_FAMILY_ATTRIBUTE_V6);

        expectedReturn = true;
        actualReturn = requestedAddressFamilyAttribute.equals(target);
        assertEquals("RequestedAddressFamilyAttribute.equals() failed for IPv6 address.", expectedReturn, actualReturn);
    }
    ...
    public void testDecodeAttributeBodyV4() throws StunException {
        ...
        assertEquals("RequestedAddressFamilyAttribute.decode() did not properly decode " + "the family field.",
                MsgFixture.REQUESTED_ADDRESS_FAMILY_ATTRIBUTE_V4, requestedAddressFamilyAttribute.getFamily());
    }
    ...
    public void testDecodeAttributeBodyV6() throws StunException {
        ...
        assertEquals("RequestedAddressFamilyAttribute.decode() did not properly decode.", MsgFixture.REQUESTED_ADDRESS_FAMILY_ATTRIBUTE_V6,
    ...
    public void testEncodeV4() {
        ...
        assertTrue("RequestedAddressFamilyAttribute.encode() did not " + "properly encode a sample attribute for IPv4 family",
    ...
    public void testEncodeV6() {
        ...
        requestedAddressFamilyAttribute.setFamily(MsgFixture.REQUESTED_ADDRESS_FAMILY_ATTRIBUTE_V6);
        byte[] actualReturn = requestedAddressFamilyAttribute.encode();
        assertTrue("RequestedAddressFamilyAttribute.encode() did not " + "properly encode a sample attribute for IPv6 family",
                Arrays.equals(expectedReturn, actualReturn));
    }
    ...
    public void testGetFamily() {
        ...
        assertEquals("Family is not properly calculated", expectedReturn, actualReturn);
