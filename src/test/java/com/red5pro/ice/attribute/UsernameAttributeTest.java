...
public class UsernameAttributeTest extends TestCase {
    ...
    byte[] attributeBinValue = new byte[] { (byte) (UsernameAttribute.Type.USERNAME.type >> 8),
            (byte) (UsernameAttribute.Type.USERNAME.type & 0x00FF), 0, (byte) usernameValue.length(), 'u', 's', 'e', 'r', 'n', 'a', 'm',
            'e' };
    ...
    public void testEncode() {
        assertTrue("encode failed", Arrays.equals(usernameAttribute.encode(), attributeBinValue));
    }
    ...
    public void testSetGetUsername() {
        ...
        assertTrue("username setter or getter failed", Arrays.equals(expectedReturn, actualReturn));
    }
}
