 ...
 *
 */
public class ConnectionIdAttributeTest extends TestCase {
    ...
    public void testGetDataLength() {
        ...
        this.connectionIdAttribute.setConnectionIdValue(MsgFixture.CONNECTION_ID);
    ...
    public void testEqualsObject() {
        ...
        assertEquals("ConnectionIdAttribute.equals() failed against a null target.", expectedReturn, actualReturn);
        ...
        assertEquals("ConnectionIdAttribute.equals() failed against a different target.", expectedReturn, actualReturn);
        ...
        expectedReturn = true;
        actualReturn = connectionIdAttribute.equals(target);
        assertEquals("ConnectionIdAttribute.equals() failed against an equal target.", expectedReturn, actualReturn);
    }
    ...
    public void testEncode() {
        ...
        assertTrue("ConnectionIdAttribute.encode() did not " + "properly encode a sample attribute",
    ...
    public void testDecodeAttributeBody() throws StunException {
        ...
        assertEquals("ConnectionIdAttribute.decode() did not properly decode the " + "connection id field.", MsgFixture.CONNECTION_ID,
    ...
    public void testGetConnectionIdValue() {
        ...
        assertEquals("ConnectionId is not properly calculated", expectedReturn, actualReturn);

        expectedReturn = 0x2222;
        this.connectionIdAttribute.setConnectionIdValue(MsgFixture.CONNECTION_ID_2);
