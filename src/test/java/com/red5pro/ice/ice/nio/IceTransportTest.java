...
public class IceTransportTest {
    ...
    public void testUDPWithGoogleStun() {
        ...
        System.setProperty("com.red5pro.ice.ice.harvest.NAT_HARVESTER_LOCAL_ADDRESS", localIP);
        System.setProperty("com.red5pro.ice.ice.harvest.NAT_HARVESTER_PUBLIC_ADDRESS", publicIP);
        ...
        System.setProperty("com.red5pro.ice.ice.harvest.ALLOWED_ADDRESSES", allowedIPs);
        System.setProperty("com.red5pro.ice.ice.harvest.NAT_HARVESTER_DEFAULT_TRANSPORT", transport.getTransportName());
