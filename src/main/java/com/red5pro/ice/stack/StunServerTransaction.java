...
public class StunServerTransaction {
    ...
    /**
     * Sets the response and destination. Also sets a flag that indicates response was set allowing stunstack to retransmit.
     *
    ...
    public void sendResponse(Response response, TransportAddress sendThrough, TransportAddress sendTo)
        ...
        logger.debug("send response rt {}   resp {}  thru {}   to {} ", isRetransmitting, response, sendThrough, sendTo);
