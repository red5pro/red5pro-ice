 ...
 *
 * When {@link #harvest(com.red5pro.ice.ice.Component)} is called, this harvester creates and adds to the component a
 * {@link com.red5pro.ice.ice.harvest.SinglePortUdpHarvester.MyCandidate} instance, and associates the component's local username fragment (ufrag) with this
 * candidate.
 *
