...
public class MappingCandidateHarvesters {
    ...
    public static final String NAT_HARVESTER_DEFAULT_TRANSPORT_PNAME = "com.red5pro.ice.ice.harvest.NAT_HARVESTER_DEFAULT_TRANSPORT";

    /**
     * The name of the property that specifies the local address, if any, for the pre-configured NAT harvester.
     */
    public static final String NAT_HARVESTER_LOCAL_ADDRESS_PNAME = "com.red5pro.ice.ice.harvest.NAT_HARVESTER_LOCAL_ADDRESS";

    /**
     * The name of the property that specifies the public address, if any, for the pre-configured NAT harvester.
     */
    public static final String NAT_HARVESTER_PUBLIC_ADDRESS_PNAME = "com.red5pro.ice.ice.harvest.NAT_HARVESTER_PUBLIC_ADDRESS";

    /**
     * The name of the property used to disable the AWS harvester.
     */
    public static final String DISABLE_AWS_HARVESTER_PNAME = "com.red5pro.ice.ice.harvest.DISABLE_AWS_HARVESTER";

    /**
     * The name of the property which forces the use of the AWS harvester.
     */
    public static final String FORCE_AWS_HARVESTER_PNAME = "com.red5pro.ice.ice.harvest.FORCE_AWS_HARVESTER";
     ...
     */
    public static final String STUN_MAPPING_HARVESTER_ADDRESSES_PNAME = "com.red5pro.ice.ice.harvest.STUN_MAPPING_HARVESTER_ADDRESSES";
